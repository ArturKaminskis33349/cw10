...
public class KontenerChlodniczy extends Kontener implements IHazardNotifier{
    ...
    public String toString() {
        return STR."KontenerChlodniczy{numerSeryjny='\{numerSeryjny}', masaLadunku=\{masaLadunku} kg, wagaWlasna=\{wagaWlasna} kg, wysokosc=\{wysokosc} cm, glebokosc=\{glebokosc} cm, maksymalnaLadownosc=\{maksymalnaLadownosc} kg, temperatura=\{temperatura} °C\{produkt != null ? ", produkt='" + produkt + '\'' : ""}}";
    }
