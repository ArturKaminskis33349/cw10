public class KontenerNaGaz extends Kontener implements IHazardNotifier{
    ...
    public String toString() {
        return STR."KontenerNaGaz{numerSeryjny='\{numerSeryjny}', masaLadunku=\{masaLadunku} kg, wagaWlasna=\{wagaWlasna} kg, wysokosc=\{wysokosc} cm, glebokosc=\{glebokosc} cm, maksymalnaLadownosc=\{maksymalnaLadownosc} kg, cisnienie=\{cisnienie} Pa}";
    }
}
